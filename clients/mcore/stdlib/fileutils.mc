...
let parseMCoreLibsEnv : () -> Map String String = lam.
  -- Todo: fix this
  let env = sysGetEnv "MCORE_LIBS" in
  -- let env = Some "stdlib=/Users/didrik/projects/miking/miking/stdlib:coreppl=/Users/didrik/projects/miking/miking-dppl/coreppl/src" in

  match env with Some s then
    parseMCoreLibs s
  else
